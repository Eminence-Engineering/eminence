            ...
            <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
                ...
                <div class="overflow-hidden rounded-lg border-2 border-gray-100">                
                    <div class="px-6 py-10">
                        <img class="object-cover " src={Card1} alt="Software Development"/>
                        <div class="font-bold text-xl pt-5 pb-2">Software Development</div>
                        <p class="text-gray-700 text-base">
                        Lorem ipsum dolor sit amet consecte tur quet adipiscing elit semper dalaracc lacus vel ams facilisis volutpat est.
                        </p>
                        <h1 class="inline-block pt-4 text-sm font-semibold text-gray-700 ">Read More</h1>
                    </div>
                </div>

                <div class="overflow-hidden rounded-lg border-2 border-gray-100">                
                    <div class="px-6 py-10">
                        <img class="object-cover " src={Card2} alt="Software Development"/>
                        <div class="font-bold text-xl pt-5 pb-2">Design & Innovation</div>
                        <p class="text-gray-700 text-base">
                        Lorem ipsum dolor sit amet consecte tur quet adipiscing elit semper dalaracc lacus vel ams facilisis volutpat est.
                        </p>
                        <h1 class="inline-block pt-4 text-sm font-semibold text-gray-700 ">Read More</h1>
                ...
                <div class="overflow-hidden rounded-lg border-2 border-gray-100">                
                    <div class="px-6 py-10">
                        <img class="object-cover " src={Card3} alt="Software Development"/>
                        <div class="font-bold text-xl pt-5 pb-2">Research Analysis</div>
                        <p class="text-gray-700 text-base">
                        Lorem ipsum dolor sit amet consecte tur quet adipiscing elit semper dalaracc lacus vel ams facilisis volutpat est.
                        </p>
                        <h1 class="inline-block pt-4 text-sm font-semibold text-gray-700 ">Read More</h1>
