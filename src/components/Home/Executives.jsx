  ...
  return (
    <>
        <div className="bg-primary">
            <div className="flex justify-center align-center py-20" style={{"backgroundImage": group, "backgroundPosition" : "left", "backgroundSize" : "contain"}}>
                <div className="w-4/5 justify-between items-start gap-10 lg:flex md:grid sm:grid">
                    <div className="flex flex-col gap-4 lg:w-4/12 md:w-4/5 sm:w-4/5">
                        ...
                        <span className='text-white font-medium text-small'>Lorem ipsum dolor sit amet consectetur. Nibh adipiscing ac donec nisl neque convallis. Quam leo enim ac semper velit fringilla accumsan magnis est.</span>
                    ...
                    <div className="justify-around lg:flex md:flex sm:flex lg:w-1/2">
                        <div className="flex flex-col items-center bg-white p-4 my-5 rounded lg:w-2/5 md:w-2/5 sm:h-11/12">
                            ...
                            <div className="flex justify-between w-11/12">
                                <h5>Anna Smith</h5>
                                <div className="flex">
                                    <a href=""><img className='m-1' src={instagram} width={'15px'} alt="" /></a>
                                    <a href=""><img className='m-1' src={facebook} width={'10px'} alt="" /></a>
                                </div>
                            </div>
