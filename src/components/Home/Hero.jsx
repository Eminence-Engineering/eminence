            ...
            <div className="flex items-center justify-center w-full">
                <div className="relative lg:flex md:flex sm:grid justify-between pt-16 w-4/5 h-full">
                    <div className="grid lg:w-2/5 md:w-2/5 sm:w-full h-5/6 gap-5">
                        ...
                        <p className="text-white font-medium">Your success story starts here. Harness the expertise of <span className="font-semibold">Eminence</span> to revolutionize your digital strategy and achieve unparalleled growth.</p>
