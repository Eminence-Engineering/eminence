        ...
        <div className='flex justify-center items-center'>
            <div className="w-4/5 justify-between items-center py-20 lg:flex md:flex sm:grid">
                <div className="flex flex-col lg:w-2/5 md:w-2/5 sm:w-4/5">
                    ...
                    <span className='text-grey font-medium lg:w-4/5 lg:text-sm md:text-sm sm:text-md'>Lorem ipsum dolor sit amet consectetur adipiscing elit aliquam mauris sed ma</span>
                </div>
