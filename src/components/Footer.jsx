// react
import { FaXTwitter, FaYoutube, FaLinkedinIn, FaFacebookF } from "react-icons/fa6"
    ...
    <footer className="bg-primary text-white p-5 pt-12 py-7">
      <div className="container flex flex-row flex-wrap xl:flex-nowrap justify-between gap-20 md:gap-10">
        <div className="sm:max-w-64">
          ...
          <p className="mb-5">Lorem ipsum dolor sit amet consectetur adipiscing elit aliquam mauris sed ma</p>
          <div className="flex items-center gap-4">
            <a href="" target="_blank" rel="noreferrer" className="border p-1 rounded-sm">
      ...
      <div className="container text-center mt-20">
        ...
        <p className="pt-5 text-[#B4B9C9]">
          Copyright &copy; {new Date().getFullYear()} EMINENCE Agency | All Rights Reserved |{" "}
          <Link to={"/"} className="text-[#6D758F] underline transition-all duration-200 hover:no-underline">
